...
struct NewMemoView: View {
    ...
    private let graddientView = LinearGradient(gradient: Gradient(colors: [Color(UIColor.startColor), Color(UIColor.finishColor)]), startPoint: .leading, endPoint: .trailing)
